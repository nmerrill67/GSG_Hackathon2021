...
if __name__ == '__main__':
    ...
    btc_r_fl = os.path.join(reddit_data_dir, 'CryptoCurrency_Reddit042421_9pm_BTC.csv')
    doge_r_fl = os.path.join(reddit_data_dir, 'CryptoCurrency_Reddit042421_9pm_DOGE.csv')
    eth_r_fl = os.path.join(reddit_data_dir, 'CryptoCurrency_Reddit042421_9pm_ETH.csv')
